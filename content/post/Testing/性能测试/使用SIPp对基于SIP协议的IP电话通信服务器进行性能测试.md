...
{: .center}
![SIP_Simple_Session](/image/20140511201122_SIP_Simple_Session.png)
图1 SIP的简单会话过程
...
{: .center}
![SIPp_Operating_Principle](/image/20140511201122_SIPp_Operating_Principle.jpg)
图2 SIPp工作原理
...
{: .center}
![XML_Invoke_CSV](/image/20140511201122_XML_Invoke_CSV.jpg)
图3 XML调用CSV的原理
...
{: .center}
![Network_Topology_Map](/image/20140511201122_Network_Topology_Map.gif)
图4 被测系统的网络拓扑图
