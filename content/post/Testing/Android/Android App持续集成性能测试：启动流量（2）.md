...
url: /post/Android-performance-test-start-traffic-tcpdump-wireshark
date: 2016-05-03
categories:
  - Testing
tags:
...
![wireshark host filter](/image/wireshark_host_filter.png)
...
![wireshark tcp stream menu](/image/wireshark_tcp_stream_menu.png)

在筛选出的`TCP Stream`中，将各条记录的Length进行求和，即可得到总的大小。

![wireshark tcp stream data](/image/wireshark_tcp_stream_data.png)
...
![wireshark endpoints menu](/image/wireshark_endpoints_menu.png)
