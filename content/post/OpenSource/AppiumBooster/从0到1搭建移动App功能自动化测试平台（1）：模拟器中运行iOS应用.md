...
![Appium initialize iOS Settings](/image/Appium_iOS_Settings_init.jpg)
...
![Appium inspector button](/image/Appium_Inspector_Button.jpg)

然后，点击图中红框处的按钮，即可通过`Inspector`启动模拟器，并在模拟器中加载iOS应用。

![Appium iOS Simulator Console](/image/Appium_iOS_Simulator_Console.jpg)
...
![Appium Inspector Error](/image/Appium_Inspector_Error.jpg)
...
![Appium iOS Settings bug](/image/Appium_iOS_Settings_bug.jpg)
